...
classNames = [] #Names of images without extensions
myList = os.listdir(path) #Names of images
#print(myList)
for cl in myList: #Step 1: Loading images
    curImg = cv2.imread(f'{path}/{cl}')
    images.append(curImg)
    classNames.append(os.path.splitext(cl)[0])
print(classNames)

def findEncodings(images): #Step 2: Find encodings of all images
    encodeList = []
    for img in images:
